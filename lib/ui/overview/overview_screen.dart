...
Future<void> _generatePDF() async {
  ...
  titlePage.graphics.drawImage(PdfBitmap(await _readImageData('logo2.png')),
  ...
  result = _addParagraph(
      ...
      false);
  result = _addParagraph(result.page, 'The PDF Standard',
      Rect.fromLTWH(20, result.bounds.bottom + 25, 495, pageSize.height), true);
  ...
  result = _addParagraph(
      ...
      Rect.fromLTWH(20, result.bounds.bottom + 20, 495, pageSize.height),
      false);
  result = _addParagraph(result.page, 'Chapter 1 Conceptual Overview',
      Rect.fromLTWH(20, result.bounds.bottom + 25, 495, pageSize.height), true,
      mainTitle: true);
  tableContent = _addTableOfContents(
      tableContent.page,
  ...
  page2.graphics.drawImage(PdfBitmap(await _readImageData('logo2.png')),
  ...
  result = _addParagraph(
      ...
      Rect.fromLTWH(20, result.bounds.bottom + 20, 495, pageSize.height),
      false);
  result = _addParagraph(result.page, 'Body',
      Rect.fromLTWH(20, result.bounds.bottom + 25, 495, pageSize.height), true);
  tableContent = _addTableOfContents(
      tableContent.page,
      'Body',
  ...
  page3.graphics.drawImage(PdfBitmap(await _readImageData('logo2.png')),
  ...
  result = _addParagraph(
      ...
      Rect.fromLTWH(20, result.bounds.bottom + 20, 495, pageSize.height),
      false);
  result = _addParagraph(result.page, 'Trailer',
      Rect.fromLTWH(20, result.bounds.bottom + 25, 495, pageSize.height), true);
  tableContent = _addTableOfContents(
      tableContent.page,
      'Trailer',
  ...
  result = _addParagraph(
      ...
      Rect.fromLTWH(20, result.bounds.bottom + 20, 495, pageSize.height),
      false);
  result = _addParagraph(result.page, 'Summary',
      Rect.fromLTWH(20, result.bounds.bottom + 25, 495, pageSize.height), true);
  tableContent = _addTableOfContents(
      tableContent.page,
      'Summary',
  ...
  result = _addParagraph(
      ...
      Rect.fromLTWH(20, result.bounds.bottom + 20, 495, pageSize.height),
      false);
  result.page.graphics.drawImage(PdfBitmap(await _readImageData('logo2.png')),
...
// Add header logo to the PDF document
  ...
  final List<Map<String, dynamic>> measurements = [
    {'date': '01/01/2023', 'task': 'Completed Task A', 'trlLevel': 'TRL 6'},
    {'date': '02/01/2023', 'task': 'Completed Task B', 'trlLevel': 'TRL 5'},
    {'date': '03/01/2023', 'task': 'Completed Task C', 'trlLevel': 'TRL 4'},
  ];
...
Future<void> _createPDF2() async {
  ...
  final PdfImage logoImage =
      PdfBitmap(await File('assets/images/logo.png').readAsBytes());
